...
<form id="form_app" autocomplete="false" action="{{ route('applicant.restore', ['post_id'=>$post ]) }}" method="post">
{{ csrf_field() }}
           ...
           <div autocomplete="off" class="form-table_inner">
                    <div class="form_group-app">                      
                        <div  class="form_item">
                            ...
                            <div class="alert_inner_item">                           
                            <input id="datepicker" class="form__input3 post__title3" type="text" name="date_id" value="{{ $post->created_at }}" disabled>                            
                            </div>
                        </div> 
                        <div  class="form_item">
                            <div  class="label_title"><label for="surname">Фамилия</label></div>
                            <div class="alert_inner_item">                            
                            <input id="surname" class="form__input3 post__title3" type="text" name="surname" value="{{ $post->surname }}"  >
                        ...
                        <div  class="form_item">
                            ...
                            <div class="alert_inner_item">                            
                            <input id="name" class="form__input3 post__title3" type="text" name="name" autocomplete="off"  value="{{ $post->name }}">
                        ...
                        <div  class="form_item">
                            ...
                            <div class="alert_inner_item">                            
                            <input id="middle" class="form__input3 post__title3" type="text" name="middle" autocomplete="off" value="{{ $post->middle }}">
                        ...
                        <div  class="form_item">
                            ...
                            <div class="alert_inner_item">                            
                            <input id="date_id" type="text" name="dateofbirth" class="datepicker form__input3 post__title3" autocomplette="off" value="{{ $post->dateofbirth }}">
                        ...
                        <div  class="form_item">
                            ...
                            <div class="alert_inner_item">                            
                            <input id="result" class="form__input3 post__title3" type="text" name="age" autocomplete="off" readonly value="{{ $post->age }}">
                        ...
                        <div  class="form_item">
                            ...
                            <div class="alert_inner_item">                            
                            <input id="passport" class="form__input3 post__title3" type="text" name="passport" value="{{ $post->passport }}">
                        ...
                        <div  class="form_item">
                            ...
                            <div class="alert_inner_item">                           
                            <input id="department_id" class="form__input3 post__title3" type="text" name="department" autocomplete="off" value="{{ $post->department }}" >
                            <span class="text-danger error-text department_error"></span>
                            </div>
                        </div>
                        <div  class="form_item">
                            <div  class="label_title"><label for="filename">Отсканированный паспорт</label></div>
                            <div class="alert_inner_item">                            
                        ...
                        <div  class="form_item">
                            ...
                            <div class="alert_inner_item">                           
                            <input id="tin" class="form__input3 post__title3" type="text" name="tin" autocomplete="off" value="{{ $post->tin }}">
                        ...
                        <div  class="form_item">
                            ...
                            <div class="alert_inner_item">                            
                            <input id="phone" class="form__input3 post__title3" type="text" name="phone" autocomplete="off" value="{{ $post->phone }}">
                        ...
                        <div  class="form_item">
                            ...
                            <div class="alert_inner_item">                            
                            <input id="email" class="form__input3 post__title3" type="text" name="email"  value="{{ $post->email }}">
                  ...
                  <div class="form_address-item">
                        ...
                        <div  class="residential_block">
                            ...
                            @foreach ($area as $choice)
                                <option value="{{ $choice->id}}"  {{ $choice->id == $post->oblast ? 'selected' : '' }}>
                                    {{ $choice->name_ru }} 
                        ...
                        <div  class="residential_block">
                         ...
                         <div class="street" autocomplete="off">
                            ...
                            <div class="alert_inner3">                            
                            <input type="text" autocomplete="off" id="address" class="form__input3 post__title3"  name="address" value="{{ $post->address }}" >
                       ...
                       <div class="residential_address2">
                            <div  class="residential_address-text2">
                            <label><input type="checkbox" id="duplicate-address" name="duplicate-address" value="shipping same as billing">&nbsp;&nbsp;Фактически адрес совпадает с адресом по прописке</label>
                            </div>
                        </div>
                       ...
                       <div class="form_address-item">
                        ...
                        <div class="residential_block">
                           <div class="residential_block-text">            
                            ...
                            <option value="">Выберите адрес</option>
                            @foreach ($area as $choice)
                                <option value="{{ $choice->id}}"   {{ $choice->id == $post->oblast2 ? 'selected' : '' }}>
                                    {{ $choice->name_ru }} 
                        ...
                        <div class="street" autocomplete="off">
                            <div  class="street-text"><div>Улица, дом, квартира</div></div>
                            <div class="alert_inner3">                            
                            <input type="text" autocomplete="off" id="address2" class="form__input3 post__title3"   name="address2"  value="{{ $post->address2 }}" >
        ...
        function fetch_customer_data()
        {
          ...
          success:function(response)
          {
            if(response.post_o == 5 || response.post_o == 8 || response.post_o == 13) {
              $('.form__input3').prop('disabled', true);
            } else if (response.post_o == 9) {
              $('.form__input3').prop('disabled', false);
            }
